...
class MT5Order:
    ...
    def close_position(self, id: Union[str, int], volume: Optional[Union[str, int, float]] = None,
                       comment: Optional[str] = ""):
        return close_position(self._connection, id, volume=volume, comment=comment)
